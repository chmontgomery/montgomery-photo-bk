...
Galleria = function() {
	...
	// Shiba Gallery
    this.$( 'container' ).addClass( 'shiba-outer' );
    this.$( 'stage' ).addClass( 'shiba-stage' );
...
Galleria.prototype = {
    ...
    */
    ...
    load : function( source, selector, config ) {
		...
		// Shiba Gallery get titles
//		self.titles = $( source ).find("a[rel^='lightbox'],a[rel^='lytebox']");
		self.titles = $( source ).find(".shiba-link");
		if ( self._options.lightbox ) {
			self.titles.bind( 'click', function(event) {
				self.openLightbox();
			});
		}
        ...
        $( source ).find( selector ).each( function( i, elem ) {
            ...
            $.each( 'big title description link layer'.split(' '), function( j, val ) {
                if ( elem.data(val) ) {
            ...
            return function() {
                ...
                if ( data.link || self._options.lightbox || self._options.clicknext ) {
                    ...
                    $( next.image ).css({
                        ...
                        // clicknext
                        if ( self._options.clicknext /*&& !Galleria.TOUCH - Shiba Gallery*/ ) {
						...
						// Shiba Gallery
						if (self.titles[queue.index]) {
							$(self.titles[queue.index])[0].click(); //trigger('click');
							return;
						}
    ...
    */
    ...
    setInfo : function( index ) {
        ...
        $.each( ['title','description'], function( i, type ) {
			...
			// Shiba Gallery - changed html to append
			if ((type == 'title') && self.titles[index]) {
//				console.log(jQuery._data( self.titles[index], "events" ));

				elem.children().detach();
				$(self.titles[index]).show(); 
				// For some reason innerText gets lost in IE
				self.titles[index].innerText = data[ type ]; 
                elem[ data[ type ].length ? 'show' : 'hide' ]().append(self.titles[index]);
			} else if ( !!data[type] ) {
